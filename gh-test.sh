...
echo "$msg_info #1. Установка зависимостей: $msg_reset"
if npm ci
then
...
echo "$msg_info #2. Прогоним проверку на ошибки линтера: $msg_reset"
if npm run lint
then
...
echo "$msg_info #3. Проверим на ошибки TS: $msg_reset"
if npm run ts
then
